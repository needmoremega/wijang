...
<template>
  <div
    class="flex justify-center items-center min-h-screen p-4 bg-gray-100 dark:bg-gray-900 transition-colors duration-300"
  >
    <div
      class="card bg-white dark:bg-gray-800 w-full max-w-md p-6 rounded-lg shadow-xl border border-gray-300 dark:border-gray-700"
    >
      ...
      <h3
        class="text-center text-2xl font-semibold text-gray-800 dark:text-gray-200 transition-all duration-300"
      >
        {{ formTitle }}
      </h3>
